import { isHexColor, normalizeTheme } from "@/features/checkouts/lib/checkout-theme";
import { createLocalId } from "@/features/checkouts/lib/create-id";
import { isRecord } from "@/features/checkouts/lib/schema-normalizers";
import { getSectionDefinition, SECTION_REGISTRY } from "@/features/checkouts/lib/section-registry";
import { createLegacySchema, createTemplateSchema } from "@/features/checkouts/lib/templates";
import {
 ...
 */
export function toCustomization(raw: Record<string, unknown> | undefined): CheckoutCustomization {
